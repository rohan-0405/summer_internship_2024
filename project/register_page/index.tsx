  ...
  const validationSchema = Yup.object().shape({
    ...
    password: Yup.string()
      ...
      .matches(
        ...
        "Password must have minimum 8 characters, maximum 16 characters, at least one uppercase letter, one lowercase letter, one number and one special characters"
      ),
